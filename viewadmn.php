...
<section id="bannerSection" style="background:url(themes/images/banner/portfolio.png) no-repeat center center #000;">
  <div class="container" >
    <h1 id="pageTitle">Admin <small> : Manage Admin List</small>
...
<h3>&nbsp;&nbsp;&nbsp;<i class="icon-eye"></i> <span class="style15">View Admin</span></h3>
<section id="middleSection">
  <?php $selectQuery = "select * from mstr_admin ";
...
while($record = mysqli_fetch_array($resultSet))
  ...
  ?>
        ...
        <td><a href="editadmin.php?adminid=<?php echo $record["username"];?>">
      <i class="icon-edit icon-large"></i> </a></td>
        <td><a href="deleteadmin.php?adminid=<?php echo $record["username"];?>">
  ...
  ?>
      ...
      <div align="right">
      <a class="btn btn-success" href="addadmin.php" align="right"><i class="icon icon-plus"></i>&nbsp;Add An Admin</a>
    </div>
    </div>
