...
include ('head.php');
include("config.php");
$admname = $_GET["adminid"];
$selectQuery = "select * from mstr_admin where username = '".$admname."' ";
$rs = mysqli_query($link,$selectQuery);
...
<h3>&nbsp;&nbsp;&nbsp;<i class="icon-edit"></i> <span class="style15">&nbsp;&nbsp;Edit Admin</span></h3>
<section id="form">
	<div class="container">
		<div class="row-fluid">
  <form action="updateadmin.php" method="post" enctype="multipart/form-data" name="form1">
          <div  class="row-fluid">
            <div  class="span4">
              <label>Old Admin Name</label>
              <input type="text" name="uname" class="input-block-level" type="text" id="username" readonly="yes"
               value="<?php echo $record["username"]; ?>"/>
              <label>New Admin Name </label>
              <input type="text" class="input-block-level" name="newadmname" required="required" placeholder=" New Name">
						</div>
 						<div class="span4">
							<label>Old Password</label>
              <input type="text" name="pswrd" class="input-block-level" type="text" id="username" readonly="yes"
               value="<?php echo $record["password"]; ?>"/>
              <label>New Password</label>
              <input type="text" class="input-block-level" name="newpswrd" required="required" placeholder=" New Name"><div align="right">
