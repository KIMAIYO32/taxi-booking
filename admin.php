  ...
  <div class="container" align="center">
  		<div class="row" style="text-align:center">
  			...
  			<div class="well well-large">
  				<h4>The Following are Admin Functions:</h4>
            <hr>
              <p>As an admin the roles asigned are to Update, Delete &amp; Post Details entailing Data to the site for the users</p>
                  <a class="btn btn-success" href="addadmin.php"><i class="icon-plus"></i>Add An Admin</a>&nbsp;<a class="btn" href="viewadmn.php">View Admin</a>
            </hr>
  				</div>
  			</div>
      </div>
