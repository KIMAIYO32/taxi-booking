...
<section id="headerSection">
  ...
  <section id="bannerSection" style="background:url(themes/images/banner/portfolio.png) no-repeat center center #000;">
  	<div class="container" >
  		<h1 id="pageTitle">Admin <small> : Gain Access as Admin</small>
...
<p>&nbsp;</p>
  ...
  <div class="container" align="center">
  		<div class="row" style="text-align:center">
            ...
            <form action="checkadmin.php" enctype="multipart/form-data" method="post">
            <label>Admin ID:</label><input type="text" name="admnid" value="" placeholder="Admin Username" required="yes">
            <label>Password:</label><input type="password" name="psrwd" value="" placeholder="Password" required="yes"></br>
