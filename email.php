	...
	<div class="container">
		<div class="navbar">
			<div class="container">
				...
				<h1><a class="brand" href="home.php">SuzyIT  <small>  Ltd.</small></a></h1>
			</div>
		</div>
	</div>
</section>
...
<div class="container">
		<div class="row" style="text-align:center">
          ...
          <?php http_response_code(500);
				echo "<h1><span class='badge badge-success badge-large'></span><span class='colored-text'>Thank You!</span>
				<p> Your message has been sent</p></h1>"; ?>
					<p></p>
					<br/>
					<br/>
				</div>
				<a  href="home.php"><button type="submit" class="btn btn-success btn-large">
          <i class="icon icon-home"></i>&nbsp;&nbsp;Home Page</button></a>
        	</div>
		</div>
</div>
</section>
	...
	<!-- Facebook -->
		<div id="facebook" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="facebook" aria-hidden="true">
		  ...
		  <div class="modal-body">
			<p>"Our aim is simple - to provide affordable web design and development
				 services for Mobile and Computer by creating websites that fully meet
				 your requirements a professional look that inspire confidence in your customer."</p>
		  </div>
